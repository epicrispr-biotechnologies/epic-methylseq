...
## DMC table
Differentially methylated CpGs are calcualted using methylKit.
...
# Make BED tables
sig_methdiff_10_bed <- cbind(perc.meth.cpg$chr, bed_start, perc.meth.cpg$end, ".", ".", ".", bed_start, bed_start, sig_methdiff_10_rgb)
sig_methdiff_5_bed <- cbind(perc.meth.cpg$chr, bed_start, perc.meth.cpg$end, ".", ".", ".", bed_start, bed_start, sig_methdiff_5_rgb)
meth_diff_rgb_bed <- cbind(perc.meth.cpg$chr, bed_start, perc.meth.cpg$end, ".", ".", ".", bed_start, bed_start, methdiff_rgb)
# Write BED files
write.table(
  sig_methdiff_10_bed,
