...
datatable(
  ...
  caption= htmltools::tags$caption(
    ...
    "10X CpG = Number of CpGs in CD81 and off-target regions with at least 10X coverage."
  )
) %>% formatRound(
...
cat("CD81 and off-target region CpGs with at least 10X coverage in all samples:") 
