...
```{r chromhmm, eval=mouse_or_human}
...
```{r chromhmm_plot, fig.height=10, fig.width=13, eval=mouse_or_human}
...
```{r chromhmm_table, eval=mouse_or_human}
# Display in table
round_cols <- c("qvalue", "meth.diff")
bp_cols <- c("start", "end")
...
```{r ccre_plot, fig.height=10, fig.width=13, eval=mouse_or_human}
...
```{r ccre_table, eval=mouse_or_human}
# Display in table
round_cols <- c("qvalue", "meth.diff")
bp_cols <- c("start", "end")
...
```{r blacklist, eval=mouse_or_human}
...
```{r blacklist_table, eval=mouse_or_human}
# Display in table
round_cols <- c("qvalue", "meth.diff")
bp_cols <- c("start", "end")
