...
tile.obj=invisible(tileMethylCounts(myobj,win.size=100,step.size=100,cov.bases=5))
...
## CpG
Euclidean distances between samples for % methylation of CpGs.
...
## Tile
Euclidean distances between samples for % methylation of tiles.
