...
myPCASamples(meth, screeplot=TRUE)
```
...
PCASamples(meth.tile, screeplot=TRUE)
myPCASamples(meth.tile, screeplot=TRUE)
```
...
=======
```{r percent_methylation_cpg, echo=FALSE, message = FALSE}
>>>>>>> methylkit_spencer_dev
...
file1 <- paste0(params$out_path, "/", params$study, "_dmc.tsv")
message(file1)
print(paste("File path for CpG file:", file1))  # Debugging statement
write.table(
  perc.meth.cpg,
  file = file1,
  sep="\t",
...
file2 <- paste0(params$out_path, "/", params$study, "_dmc_qval_0.01_methdiff_10.tsv")
print(paste("File path for DMC file:", file2))  # Debugging statement
write.table(
  perc.meth.cpg.sig,
  file = file2,
  sep="\t",
