...
subtitle: "Sabra Djomehri & Emily Dabe, Excelra"
params:
  eval_chunk: TRUE
output:
  html_document:
    ...
    toc_depth: 2
    self_contained: yes
    template: "/home/rstudio/00_code/opp_markdown_reports/op2_template/report.html"
template_dir: "/home/rstudio/00_code/opp_markdown_reports/op2_template"
...
filename_string="methyl.part4.merged.EPIvCtrl"
...
if (file.exists(paste0(base_folder,comparison_folder,filename_string,".rds"))) {
  ...
  myobj=methRead(file.list,
                 sample.id=list("c1","c2","c4","c5","c7","c8"),
                 assembly="GRCh38",
