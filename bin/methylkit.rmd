...
meth=methylKit::unite(myobj, destrand=FALSE, mc.cores=25)
```
...
invisible(capture.output({tile.obj = tileMethylCounts(myobj,win.size=100,step.size=100,cov.bases=5, mc.cores=25)}))
...
meth.tile=methylKit::unite(tile.obj, destrand=FALSE, mc.cores=25)
```
...
myDiff=calculateDiffMeth(meth, mc.cores=25)
# find DMRs 
myDiff.tile=calculateDiffMeth(meth.tile, mc.cores=25)
